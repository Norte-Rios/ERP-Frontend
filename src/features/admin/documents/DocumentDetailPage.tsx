...
const DocumentDetailPage: React.FC<DocumentDetailPageProps> = ({ documents, onAddComment }) => {
  ...
  if (!document) {
    return (
      <div className="text-center p-10">
        ...
        <Link to="/documents" className="text-indigo-600 hover:underline mt-4 inline-block">
  ...
  return (
    <div className="container mx-auto">
      <div className="mb-6">
        <Link to="/documents" className="text-indigo-600 hover:underline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          ...
          <div className="lg:col-span-2">
            ...
            <form onSubmit={handleCommentSubmit} className="mt-6 pt-6 border-t">
              <label htmlFor="newComment" className="block text-sm font-medium text-gray-700 mb-2">Adicionar um comentário</label>
              <textarea
                id="newComment"
                value={newComment}
