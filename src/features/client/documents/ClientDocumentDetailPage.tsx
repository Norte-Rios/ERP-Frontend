...
interface ClientDocumentDetailPageProps {
  documents: Document[];
...
const ClientDocumentDetailPage: React.FC<ClientDocumentDetailPageProps> = ({ documents, onAddComment }) => {
  ...
  if (!document) {
    return (
      <div className="text-center p-10">
        ...
        <Link to="/client/documents" className="text-indigo-600 hover:underline mt-4 inline-block">
  ...
  return (
    <div className="container mx-auto">
      <div className="mb-6">
        <Link to="/client/documents" className="text-indigo-600 hover:underline">
...
export default ClientDocumentDetailPage;