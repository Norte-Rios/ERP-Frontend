...
interface ConsultantDocumentsPageProps {
  documents: Document[];
...
const ConsultantDocumentsPage: React.FC<ConsultantDocumentsPageProps> = ({ documents, consultantName, onAddDocument }) => {
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    if (file) {
      ...
      const newDoc = {
        ...
        recipient: { id: 'ADMIN', name: 'Admin', type: 'Consultor' as const },
      };
    ...
    <div className="container mx-auto">
      ...
      {isUploading && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-4">O destinatário será o Administrador do sistema.</p>
            <div 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        {filteredDocuments.map((doc) => (
          <Link to={`/consultant/documents/${doc.id}`} key={doc.id} className="block">
